@php
    $filmSets = [
        [
            'text' => 'Tầm nhìn panoramic, golden hour và ánh sáng tự nhiên — lý tưởng cho những khung hình cưới đầy cảm xúc giữa hoàng hôn Hà Nội.',
        ...
        [
            'text' => 'Concept sân vườn, phong cách minimalist trong không gian giàu cảm xúc — nơi mỗi góc chụp đều kể câu chuyện tình yêu của riêng hai bạn.',
...
<section id="section-film-set" class="py-5 overflow-hidden">
    <div class="container-xl">
        <div class="text-center text-uppercase mx-auto mb-5 col-lg-8 section-title-wrapper">
            ...
            <p class="section-description" data-aos="fade-up">Phim trường</p>
        </div>
